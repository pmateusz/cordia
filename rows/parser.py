...
class Parser:
    ...
    def __init__(self, data_source, program_name=None):
        ...
        visualisation_parser = subparsers.add_parser(name='visualise',
                                                help='visualise the information of the optimal schedule as a network graph and excel spreadsheet')
        visualisation_parser.add_argument('-f', Parser.VISUALISATION_FILE_ARG,
                                     help='the name of the solution file generated by the optimiser that needs to be visualised',
                                     type=str,
                                     default=None)
        visualisation_parser.add_argument('-o', Parser.VISUALISATION_OUTPUT_ARG,
                                     help='the name of the output file generated by the visualisation module  (no extension needed)',
                                     type=str,
                                     default='visual_schedule')
