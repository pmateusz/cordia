...
do
local_date=$date
problem_prefix=c350past_riskinessv90b90e30m1m1m1
/home/pmateusz/dev/cordia/build/rows-main --problem=/home/pmateusz/dev/cordia/simulations/current_review_simulations/problems/C350_past.json --maps=/home/pmateusz/dev/cordia/data/scotland-latest.osrm --history=/home/pmateusz/dev/cordia/simulations/current_review_simulations/problems/C350_history.json --console-format=log --preopt-noprogress-time-limit=00:01:00 --opt-noprogress-time-limit=00:01:00 --postopt-noprogress-time-limit=00:01:00 --break-time-window=00:90:00 --visit-time-window=00:90:00 --begin-end-shift-time-extension=00:30:00 --output=$problem_prefix _$local_date.gexf --scheduling-date=$local_date --third-stage=delay-riskiness-reduction 1> $problem_prefix_$local_date.log 2> $problem_prefix_$local_date.err.log
done