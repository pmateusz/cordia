...
../rows_compare.py compare-distance --problem c350_forecasted_problem.json --schedule_patterns "./350_distance/c350dv90b90e15m2m4m8_201710*.gexf" "./350_distance/second_stage_c350dv90b90e15m2m4m8_201710*.gexf" "./human/c350human_201710*.json" --labels "3 Level Constraint Programming" "2 Level Constraint Programming" "Human Planners" --output=compare_distance_350
