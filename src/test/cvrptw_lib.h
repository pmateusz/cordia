...
// Manhattan distances/times between locations.
    ...
    public:
        ...
        int64 ManhattanDistance(
                operations_research::RoutingNodeIndex from,
        ...
        int64 ManhattanTime(operations_research::RoutingNodeIndex from,
                            operations_research::RoutingNodeIndex to) const;

        bool SameLocation(operations_research::RoutingNodeIndex node1,
    ...
    private:
        ...
        const int64 speed_;
        gtl::ITIVector<operations_research::RoutingNodeIndex, Location> locations_;
    };

//// Random demand.
//    class RandomDemand {
//    public:
//        RandomDemand(int size, operations_research::RoutingNodeIndex depot,
//                     bool use_deterministic_seed);
//
//        void Initialize();
//
//        int64 Demand(operations_research::RoutingNodeIndex from,
//                     operations_research::RoutingNodeIndex to) const;
//
//    private:
//        std::unique_ptr<int64[]> demand_;
//        const int size_;
//        const operations_research::RoutingNodeIndex depot_;
...
//                operations_research::RoutingModel::TransitCallback2 *demand,
//                operations_research::RoutingModel::TransitCallback2 *transition_time);
//
//        int64 Compute(operations_research::RoutingNodeIndex from,
//                      operations_research::RoutingNodeIndex to) const;
//
//    private:
//        const int64 time_per_demand_unit_;
//        std::unique_ptr<operations_research::RoutingModel::TransitCallback2> demand_;
//        std::unique_ptr<operations_research::RoutingModel::TransitCallback2>
//                transition_time_;
//    };
//
