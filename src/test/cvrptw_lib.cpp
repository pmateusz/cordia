...
namespace operations_research {
    ...
    int64 LocationContainer::ManhattanDistance(operations_research::RoutingNodeIndex from,
    ...
    int64 LocationContainer::NegManhattanDistance(
            operations_research::RoutingNodeIndex from, operations_research::RoutingNodeIndex to) const {
        return -ManhattanDistance(from, to);
    }

    int64 LocationContainer::ManhattanTime(operations_research::RoutingNodeIndex from,
                                           operations_research::RoutingNodeIndex to) const {
        return ManhattanDistance(from, to) / speed_;
    }

    bool LocationContainer::SameLocation(operations_research::RoutingNodeIndex node1,
                                         operations_research::RoutingNodeIndex node2) const {
...
//    RandomDemand::RandomDemand(int size, operations_research::RoutingNodeIndex depot,
...
//    }
//
//    int64 RandomDemand::Demand(operations_research::RoutingNodeIndex from,
//                               operations_research::RoutingNodeIndex /*to*/) const {
//        return demand_[from.value()];
//    }
//
//    ServiceTimePlusTransition::ServiceTimePlusTransition(
//            int64 time_per_demand_unit, RoutingModel::TransitCallback2 *demand,
//            RoutingModel::TransitCallback2 *transition_time)
//            : time_per_demand_unit_(time_per_demand_unit),
//              demand_(demand),
//              transition_time_(transition_time) {}
//
//    int64 ServiceTimePlusTransition::Compute(operations_research::RoutingNodeIndex from,
//                                             operations_research::RoutingNodeIndex to) const {
//        return time_per_demand_unit_ * demand_->(from, to) +
//               transition_time_(from, to);
//    }
//
...
//              transition_time_(transition_time) {}
//
//    int64 StopServiceTimePlusTransition::Compute(operations_research::RoutingNodeIndex from,
//                                                 operations_research::RoutingNodeIndex to) const {
...
//            std::set<int> visited;
//            const operations_research::RoutingNodeIndex kFirstNodeAfterDepot(1);
//            for (operations_research::RoutingNodeIndex order = kFirstNodeAfterDepot;
//                 order < routing.nodes(); ++order) {
//                ++group_size;
//                visited.insert(plan.Value(routing.VehicleVar(index_manager.NodeToIndex(order))));
